...
set kernel_name    "kernel_wrapper"
set kernel_vendor  "nus.edu"
...
proc edit_core {core} {
  ...
  set reg      [::ipx::add_register -quiet "in_data" $addr_block]
  set_property address_offset 0x010 $reg
  set_property size           [expr {8*8}]   $reg
  set regparam [::ipx::add_register_parameter -quiet {ASSOCIATED_BUSIF} $reg] 
  set_property value m00_axi $regparam 

  set reg      [::ipx::add_register -quiet "out_data" $addr_block]
