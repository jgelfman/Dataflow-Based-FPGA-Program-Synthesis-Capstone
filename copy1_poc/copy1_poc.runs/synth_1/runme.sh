...
HD_PWD='/home/jon/Desktop/capstone/copy1_poc/copy1_poc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log copy1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source copy1_wrapper.tcl
