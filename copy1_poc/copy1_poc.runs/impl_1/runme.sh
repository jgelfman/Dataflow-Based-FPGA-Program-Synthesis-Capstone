...
HD_PWD='/home/jon/Desktop/capstone/copy1_poc/copy1_poc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log copy1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source copy1_wrapper.tcl -notrace
